  ...
  function (
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      postCreate: function () {
        ...
        //to override jimu tree check node in FF and safari
        if (jimuUtils.has('ff') || jimuUtils.has('safari')) {
          var node = dojoQuery(".jimu-tree .jimu-tree-check-node", this.singleLayerChooser);
          array.forEach(node,function(node){
            domClass.add(node, "esriCTTreeNode");
          });          
        }
      },
